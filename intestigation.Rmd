...
# Dummy variable
laptop_recipe <- recipe(Price ~ ., data = laptop_data_cleaned) %>%
...
# Dummy variable
laptop_final_recipe <- recipe(Price ~ ., data = laptop_data_cleaned) %>%
  step_dummy(all_nominal(), -all_outcomes()) %>%
  step_rm(HDD, Storage_space, Ips)
# Build model
